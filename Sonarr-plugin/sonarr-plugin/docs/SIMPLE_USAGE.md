...
2. Wait for the console window to show: `Uvicorn running on http://0.0.0.0:8242`
3. Your browser should automatically open to http://localhost:8242

> **Tip:** If the browser doesn't open automatically, manually navigate to http://localhost:8242
...
**URL:** http://localhost:8242/config
...
**URL:** http://localhost:8242/torrents
...
**URL:** http://localhost:8242/folder-watcher
...
- **API Docs**: Visit http://localhost:8242/docs for API details
